...
$(document).ready(function(){
   ...
   $.getJSON( "./json/kiosks.json",function(data) {
      kiosks = data;
      console.log("kiosks json",data);
      loadMap();
   });
...
function onload()
{
   ...
   pathStart = [kiosks.k1.x, kiosks.k1.y];
   ...
   for (var y=0; y < worldHeight; y++)
	{
      for (var x=0; x < worldWidth; x++)
		{
         console.log(x*worldWidth+y);
         //console.log("data",map.layers[0].data[x*y]);
         world[x][y] = map.layers[0].data[i];
         i++;
		}
	}
